...
@TeleOp(group="Test")
//@Disabled
public class ShootPower2Test extends TeleOpBase {
    ...
    protected void update() {
        ...
        robot.ringShooter2.elevatorMotor.setPower(gamepad1.left_stick_y + gamepad1.right_stick_y * 0.2);
        robot.ringShooter2.shootMotor.setVelocity(gamepad1.right_stick_y * shootVelocity);
